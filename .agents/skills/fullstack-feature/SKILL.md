...
description: Create a coordinated backend and frontend feature. Use for work that spans API schemas, services, routers, plus frontend types, services, hooks, and UI.
---

# Full-Stack Feature

Use this when one feature crosses backend and frontend boundaries and should land as a coordinated slice.
Prefer parallel implementation, but keep the contract between backend responses and frontend types aligned.
