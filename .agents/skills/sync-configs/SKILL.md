---
name: sync-configs
description: Verify and sync Codex and Claude Code config pairs while preserving platform-specific wording. Use when editing AGENTS.md, CLAUDE.md, skills, agents, rules, or commands.
---

# Sync Configs

Use this for paired Codex/Claude config work.
