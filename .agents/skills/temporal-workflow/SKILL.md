...
description: Create a Temporal workflow with activities, registration, and calling service code. Use for durable execution, long-running orchestration, retries, or resumable jobs.
---
