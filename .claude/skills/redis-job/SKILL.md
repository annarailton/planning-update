---
name: redis-job
description: Create a Redis Streams enqueue and worker handler flow. Auto-loads for background jobs, async processing, event consumers, or worker-backed tasks.
